...
MODEL_NAME = 'cocolvis_hrnet18s_human'
...
def init_model(cfg):
    ...
    model = HRNetModel(width=18, ocr_width=48, small=True, with_aux_output=True, use_leaky_relu=True,
                       ...
                       with_prev_mask=True)
    initializer = XavierGluon(rnd_type='gaussian', magnitude=2.0)
    for sublayer in model.sublayers():
        initializer(sublayer)
...
def train(model, cfg, model_cfg):
    ...
    optimizer_params = {'learning_rate': 5e-6}
